<?php
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
            ...
            if (!preg_match("/^[a-zA-Z-' ]*$/", $first_name)) {
                ...
                $query = "INSERT INTO admin_db (first_Name, last_Name, email, phone_Number, house_Number, zone, barangay, city, province, password) VALUES ('$first_name', '$last_name', '$email', '$phone', '$house_number', '$zone', '$barangay', '$city', '$province', '$encpass')";

                if (mysqli_query($con, $query)) {
                    echo "<script>alert('Succesfully Adding New Admin');</script>";
