...
<nav class="bg-pink-50  p-4 sticky top-0 z-50 shadow-2xl">
    ...
    <main class="max-w-5xl mx-auto py-16 px-6">
        ...
        <p class="text-lg text-gray-600">Your trust matters to us. Here's how we handle your information.</p>
        </section>

        <section class="bg-white rounded-3xl shadow-lg p-10 space-y-10">
        <div>
            ...
            <li>Browsing data (pages visited, session duration, etc.)</li>
            </ul>
        </div>
        ...
        <div>
            ...
            <li>To enhance your browsing and shopping experience</li>
            <li>To send newsletters (if subscribed)</li>
            </ul>
        </div>

        <div>
            <h2 class="text-2xl font-semibold mb-2">How We Protect Your Data</h2>
            <p class="text-gray-700">We use secure technologies and practices to safeguard your personal information. All payments are encrypted and handled by trusted third-party processors.</p>
        </div>

        <div>
            <h2 class="text-2xl font-semibold mb-2">Sharing Your Information</h2>
            <p class="text-gray-700">We do not sell or rent your personal data. Information is only shared with partners like shipping providers to fulfill your orders.</p>
        </div>

        <div>
            <h2 class="text-2xl font-semibold mb-2">Your Choices</h2>
            <ul class="list-disc list-inside space-y-2 text-gray-700">
            <li>Access and update your profile details</li>
        ...
        <div>
            <h2 class="text-2xl font-semibold mb-2">Policy Updates</h2>
            <p class="text-gray-700">We may revise this policy as our services grow. Major changes will be announced with an updated date at the top of this page.</p>
        </div>
        </section>
    </main>
