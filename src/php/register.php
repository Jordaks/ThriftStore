<?php
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
            ...
            if (strlen($phone) == 11 && preg_match('/^(09\d{9})$/', str_replace([' ', '-'], '', $phone))) {
            } else {
                echo "<p style='color: red;'> Invalid phone number. It must be 11 digits and start with 09.</p>";
            }
            ...
            if (!preg_match("/^[a-zA-Z-' ]*$/", $first_name) && !preg_match("/^[a-zA-Z-' ]*$/", $last_name)) {
                ...
                $query = "insert into user_db (first_name, last_name, email, phone, house_number, zone, barangay, city, province, password) values ('$first_name', '$last_name', '$email', '$phone', '$house_number', '$zone', '$barangay', '$city', '$province', '$encpass')";
                ...
                <div class="container mx-auto flex justify-between items-center">
                    <div class="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
                        <div class="hidden sm:ml-6 sm:block">
                            ...
                            <a href="home_page.php" class="nav-link active hover:scale-110 hover:text-white hover:bg-gray-700 transition duration-500 rounded-md px-3 py-2 text-sm font-bold text-black">Home</a>
    ...
    <div class="bg-[url('/ADV_DBMS/bg.jpg')] bg-center px-20 min-h-screen grid place-items-center">
        <div class="bg-orange-100 p-12 rounded-3xl shadow-2xl w-1/2">
            ...
            <h1 class="font-bold text-3xl">Name</h1>
                <!-- NAME -->
                <div class="mt-4 flex justify-between mr-8">
                    <div class="mt-7">
                        <label for="first_name" class="block font-semibold text-m text-gray-00 "> First Name</label>
                        <input type="name" placeholder="Enter your first name" name="first_name" id="first_name" value="<?= $first_name ?>" class=" px-4 py-3 rounded-lg bg-gray-200 mt-2 border focus:border-orange-500 focus:bg-white focus:outline-none" required>
                        <span   span class="text-danger"><?= $name_error = ""; ?></span>
                    </div>
                    <div class="mt-7 left-5">
                        <label for="last_name" class="block font-semibold text-m text-gray-00 "> Last Name</label>
                        <input type="name" placeholder="Enter your last name" name="last_name" id="last_name" value="<?= $last_name ?>" class=" px-4 py-3 rounded-lg bg-gray-200 mt-2 border focus:border-orange-500 focus:bg-white focus:outline-none" required>
                ...
                <h1 class="font-bold mt-10 text-3xl">Address</h1>
                
                <!-- ADDRESS -->
                <div class="mt-4 flex justify-between mr-8">
                    <div class="mt-7">
                        <label for="house_number" class="block font-semibold text-m text-gray-00 "> House no.</label>
                        <input type="text" placeholder="Enter your House no." name="house_number" id="house_number" value="<?= $house_number ?>" class=" px-4 py-3 rounded-lg bg-gray-200 mt-2 border focus:border-orange-500 focus:bg-white focus:outline-none" required>
                        <span   span class="text-danger"><?= $name_error = ""; ?></span>
                    </div>
                    <div class="mt-7 left-5">
                        <label for="zone" class="block font-semibold text-m text-gray-00 ">Zone</label>
                        <input type="text" placeholder="Enter your zone" name="zone" id="zone" value="<?= $zone ?>" class=" px-4 py-3 rounded-lg bg-gray-200 mt-2 border focus:border-orange-500 focus:bg-white focus:outline-none" required>
                        <span class="text-danger"><?= $name_error = ""; ?></span>
                    </div>
                </div>
                ...
                <div class="mt-4 flex justify-between mr-8">
                    <div class="mt-7 left-5">
                        ...
                        <input type="text" placeholder="Enter your barangay" name="barangay" id="barangay" value="<?= $barangay ?>" class=" px-4 py-3 rounded-lg bg-gray-200 mt-2 border focus:border-orange-500 focus:bg-white focus:outline-none" required>
                        <span class="text-danger"><?= $name_error = ""; ?></span>
                    </div>
                    <div class="mt-7 left-5">
                        <label for="city" class="block font-semibold text-m text-gray-00 ">City</label>
                        <input type="text" placeholder="Enter your city" name="city" id="city" value="<?= $city ?>" class=" px-4 py-3 rounded-lg bg-gray-200 mt-2 border focus:border-orange-500 focus:bg-white focus:outline-none" required>
                        <span class="text-danger"><?= $name_error = ""; ?></span>
                    </div>
                    ...
                    <div class="mt-7 left-5">
                        <label for="province" class="block text-m font-semibold text-gray-00 ">Province</label>
                        <input type="text" placeholder="Enter your province" name="province" id="province" value="<?= $province ?>" class=" px-4 py-3 rounded-lg bg-gray-200 mt-2 border focus:border-orange-500 focus:bg-white focus:outline-none" required>
                        <span class="text-danger"><?= $name_error = ""; ?></span>
                    </div>
                <!-- PASSWORD -->
                <div class="mt-7">
